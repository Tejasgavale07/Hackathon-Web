    ...
    <div class="container">
        ...
        <form action="index.php" method="post">
            ...
            <Select name="college_name">
                ...
                <option value="Saraswati College of Engineering Kharghar">Saraswati College of Engineering Kharghar</option>
            ...
            <input type="text" placeholder="Enter Your Address : " class="inp_field" name="address">
       ...
       $con1 = new mysqli("localhost","root","","tp_clg");

       $con2 = new mysqli("localhost","root","","test_verify");

       $con3 = new mysqli("localhost","root","","pass_db");

        
       $query_1 = "select * from `clg_data`";
       $result_1= mysqli_query($con1,$query_1);

       

       $query_2 = "insert into `alumni_data` 
       (`fname`,`lname`,`email`,`gr_no`,`mobile_no`,`college_name`,`branch`,`graduate_year`,`Occupation`)
       values ('$fname','$lname','$email','$grno','$mobileno','$college_name','$branch','$graduate_yr','$occupation')";
       ...
       while($data = mysqli_fetch_assoc($result_1)){
            ...
            if(($fname== $data['fname']) && ($lname == $data['lname']) && ($grno == $data['gr_no']) && ($college_name == $data['college_name']) && ($graduate_yr == $data['graduation_year'])){

                echo "You are Authenticated and The Data is Inserted";

                mysqli_query($con2, $query_2);
